app2 = (function () {
    return {
            ...
            return apiclient.getCinemaByName(cinemaname, function (cine) {
                ...
                for (var i = 0; i < seats.length; i++) {
                    ...
                    for (var j = 0; j < seats[i].length; j++) {
                        tableSeats.append('<td><button id="myBtncine" ><img src="' +
                            ((seats[i][j] == true) ? "availableSeat.png" : "occupiedSeat.png") +
                            '" style="width:90px; height: 40px;"></button</td>');
                    }
                    tableSeats.append("</tr>");
                }
        ...
        disableBtn: function () {
            document.getElementById("myBtncine").disabled = true;

        },
        enableBtn: function () {
            document.getElementById("myBtncine").disabled = false;
        }
